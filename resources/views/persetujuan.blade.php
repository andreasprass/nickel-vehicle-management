        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Persetujuan</h3>
                </div>
                <div class="card-body">
                    <table class="table display table-striped dt-responsive nowrap" style="width:100%" id="pemesanan_table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($persetujuan->status_persetujuan == 0)
                                        <span class="right badge badge-warning">Menunggu</span>
                                    @elseif($persetujuan->status_persetujuan == 1)
                                ...
                                <td>
                                    ...
                                    <a href="{{ url("persetujuan/$persetujuan->id/edit") }}" class="btn btn-warning"><span> <i class="fas fa-pencil-alt"></i></span></a>
